...
export async function PATCH(
  ...
  await db
    ...
    .set({
      ...
      ...(data.contact_enabled !== undefined && { contactEnabled: data.contact_enabled }),
      ...(data.contact_form_visible !== undefined && { contactFormVisible: data.contact_form_visible }),
      ...(data.contact_phone !== undefined && { contactPhone: data.contact_phone }),
      ...(data.contact_phone_visible !== undefined && { contactPhoneVisible: data.contact_phone_visible }),
